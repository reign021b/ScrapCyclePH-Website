...
export default function WhatWeBuy() {
  ...
  return (
    <div className="flex flex-col items-center justify-between max-w-5xl container mx-auto pt-10 lg:pt-20 pb-28">
      ...
      <h1 className="px-5 text-4xl font-semibold mt-2 w-full text-center pb-12 border-b border-slate-200">
        We accept a wide catalog of materials and items
      </h1>

      {/* menu */}
      <div className="px-5 w-full grid grid-cols-6 gap-8 mt-8">
        <button
      ...
      {/* items */}
      {/* plastics */}
      <div ref={plasticRef} className="px-5 pt-24">
        <div className="flex">
      ...
      {/* metal */}
      <div ref={metalRef} className="px-5 pt-28">
        <div className="flex">
      ...
      {/* paper */}
      <div ref={paperRef} className="px-5 pt-28">
        <div className="flex">
      ...
      {/* e-waste */}
      <div ref={ewasteRef} className="px-5 pt-28">
        <div className="flex">
      ...
      {/* battery */}
      <div ref={batteryRef} className="px-5 pt-28">
        <div className="flex">
      ...
      {/* glass */}
      <div ref={glassRef} className="px-5 pt-28 mb-20">
        <div className="flex">
