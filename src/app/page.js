...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between px-5 md:px-10 lg:px-10 container mx-auto">
      {/* header */}
      <HomeHeader />

      {/* features */}
      <section className="scale-90 lg:scale-100 md:py-20 px-0 lg:px-20 grid grid-cols-2 lg:grid-cols-4 md:grid-cols-2 gap-10 md:gap-15 z-10">
      ...
      <section className="my-12">
        {/* top */}
        <div className="mb-16 grid grid-cols-6 gap-2 lg:gap-8">
          {/* left */}
          <div className="col-span-6 md:col-span-4 lg:col-span-4">
            <div className="rounded-2xl px-6 text-center py-4 w-64 border border-slate-600 text-xl mx-auto md:ml-0">
              How does it work?
            </div>
            <h3 className="text-3xl mt-6 md:pr-6 font-semibold leading-normal text-center md:text-left">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-9">
          {/* step 1 */}
          <div className="col-span-2 md:col-span-1 rounded-3xl overflow-clip group flex flex-col">
            {/* image */}
          ...
          {/* step 3 */}
          <div className="col-span-2 lg:col-span-1 rounded-3xl overflow-clip group flex flex-col">
            {/* image */}
            <div className="relative h-72 group-hover:scale-110 transition duration-300 ease-in-out">
              <Image
                src="/step-3.png"
      ...
      {/* articles section */}
      <section className="grid grid-cols-2 lg:grid-rows-2 grid-rows-3 gap-8 w-full h-[120vh] my-32">
        {/* article 1 */}
        <Link
        ...
        >
          {/* bg-image */}
          <div className="scale-110 lg:scale-100 h-full w-full absolute z-0 group-hover:scale-105 transition duration-500 ease-in-out">
            <Image
          ...
          {/* content */}
          <div className="scale-75 lg:scale-100 flex flex-col items-center max-w-[500px] text-center absolute z-10">
        ...
        <Link
          ...
          className="group relative col-span-2 lg:col-span-1 row-span-1 flex items-center justify-center rounded-3xl overflow-clip"
        >
          {/* bg-image */}
          ...
          <div className="absolute z-10 p-14 bg-green-800/75 h-full w-full text-white text-left flex items-end">
            <div className="w-11/12 md:w-8/12">
              ...
              <p className="text-xs md:text-lg my-6">
                ScrapCycle helps to offset businesses’ carbon footprint for
                eco-friendly organizational practices.
              </p>
              <div className="px-5 md:px-10 py-3 mt-2 w-fit rounded-2xl text-xs md:text-lg font-medium bg-white text-green-700 hover:bg-green-100 transition duration-300">
                Learn More
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="absolute z-10 p-14 bg-gradient-to-tr from-slate-50 to-transparent h-full w-full text-left flex items-end">
            <div className="w-11/12 md:w-8/12">
              ...
              <div className="px-5 md:px-10 py-3 w-fit mt-2 rounded-2xl text-xs md:text-lg font-medium bg-green-600 text-white hover:bg-green-700 transition duration-300">
                Learn More
              </div>
            </div>
          </div>
      ...
      {/* reviews section */}
      <section className="w-full flex flex-col items-center my-10 md:my-20">
        {/* title */}
        ...
        <div className="md:my-12 relative w-screen overflow-auto cursor-grab">
          {/* review container */}
          <ReviewSlides />
        </div>
      </section>
